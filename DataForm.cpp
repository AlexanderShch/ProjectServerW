...
System::Void ProjectServerW::DataForm::buttonReadParameters_Click(System::Object^ sender, System::EventArgs^ e) {
    ...
    if (ClientSocket == INVALID_SOCKET) {
        MessageBox::Show("Р СњР ВµРЎвЂљ РЎРѓР С•Р ВµР Т‘Р С‘Р Р…Р ВµР Р…Р С‘РЎРЏ РЎРѓ РЎС“РЎРѓРЎвЂљРЎР‚Р С•Р в„–РЎРѓРЎвЂљР Р†Р С•Р С. Р СџР С•Р Т‘Р С”Р В»РЎР‹РЎвЂЎР С‘РЎвЂљР ВµРЎРѓРЎРЉ Р С” Р Т‘Р ВµРЎвЂћРЎР‚Р С•РЎРѓРЎвЂљР ВµРЎР‚РЎС“.");
        if (Label_Commands != nullptr && !Label_Commands->IsDisposed) {
            Label_Commands->Text = "Р РЋРЎвЂЎР С‘РЎвЂљР В°РЎвЂљРЎРЉ РЎРѓ РЎС“РЎРѓРЎвЂљРЎР‚Р С•Р в„–РЎРѓРЎвЂљР Р†Р В°: Р Р…Р ВµРЎвЂљ РЎРѓР С•Р ВµР Т‘Р С‘Р Р…Р ВµР Р…Р С‘РЎРЏ";
            Label_Commands->ForeColor = System::Drawing::Color::Orange;
        }
        return;
    }
    ...
    if (Label_Commands != nullptr && !Label_Commands->IsDisposed) {
        Label_Commands->Text = String::Format("Р РЋРЎвЂЎР С‘РЎвЂљР В°РЎвЂљРЎРЉ РЎРѓ РЎС“РЎРѓРЎвЂљРЎР‚Р С•Р в„–РЎРѓРЎвЂљР Р†Р В°: Р В·Р В°Р С–РЎР‚РЎС“Р В¶Р ВµР Р…Р С• {0} Р С—Р В°РЎР‚Р В°Р СР ВµРЎвЂљРЎР‚Р С•Р Р†" + (fail > 0 ? ", Р С•РЎв‚¬Р С‘Р В±Р С•Р С”: " + fail : ""), ok);
...
System::Void ProjectServerW::DataForm::buttonWriteParameters_Click(System::Object^ sender, System::EventArgs^ e) {
    ...
    if (ClientSocket == INVALID_SOCKET) {
        MessageBox::Show("Р СњР ВµРЎвЂљ РЎРѓР С•Р ВµР Т‘Р С‘Р Р…Р ВµР Р…Р С‘РЎРЏ РЎРѓ РЎС“РЎРѓРЎвЂљРЎР‚Р С•Р в„–РЎРѓРЎвЂљР Р†Р С•Р С. Р СџР С•Р Т‘Р С”Р В»РЎР‹РЎвЂЎР С‘РЎвЂљР ВµРЎРѓРЎРЉ Р С” Р Т‘Р ВµРЎвЂћРЎР‚Р С•РЎРѓРЎвЂљР ВµРЎР‚РЎС“.");
        if (Label_Commands != nullptr && !Label_Commands->IsDisposed) {
            Label_Commands->Text = "Р вЂ”Р В°Р С—Р С‘РЎРѓР В°РЎвЂљРЎРЉ Р Р† РЎС“РЎРѓРЎвЂљРЎР‚Р С•Р в„–РЎРѓРЎвЂљР Р†Р С•: Р Р…Р ВµРЎвЂљ РЎРѓР С•Р ВµР Т‘Р С‘Р Р…Р ВµР Р…Р С‘РЎРЏ";
            Label_Commands->ForeColor = System::Drawing::Color::Orange;
        }
        return;
    }
    ...
    if (Label_Commands != nullptr && !Label_Commands->IsDisposed) {
        Label_Commands->Text = String::Format("Р вЂ”Р В°Р С—Р С‘РЎРѓР В°РЎвЂљРЎРЉ Р Р† РЎС“РЎРѓРЎвЂљРЎР‚Р С•Р в„–РЎРѓРЎвЂљР Р†Р С•: Р В·Р В°Р С—Р С‘РЎРѓР В°Р Р…Р С• {0} Р С—Р В°РЎР‚Р В°Р СР ВµРЎвЂљРЎР‚Р С•Р Р†" + (fail > 0 ? ", Р С•РЎв‚¬Р С‘Р В±Р С•Р С”: " + fail : ""), ok);
        Label_Commands->ForeColor = System::Drawing::Color::DarkGreen;
    }
