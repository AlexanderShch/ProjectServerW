...
#pragma endregion
	...
	public:
		...
		void ThreadSafeAddDataToTable(DataTable^ table) {	// проверяет необходимость вызова через Invoke
		...
		static void AddDataToTableWrapper(Object^ state) {	// обёртка для передачи параметров
